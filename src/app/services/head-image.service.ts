...
export class HeadImageService {
   ...
   */
  createHeadImage(pageName: string, description: string, imageFile?: File, ownerId?: string): Observable<any> {
   ...
   */
  updateHeadImage(idHeadImage: string, description?: string, imageFile?: File): Observable<any> {
    const formData = new FormData();
